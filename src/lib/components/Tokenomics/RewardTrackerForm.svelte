				...
				<div class="check-claim">
					...
					<div class="check-claim__inner">
						<div class="check-claim__action">
							<div class="check-claim__action__title">
								Send <span class="gradient">DPANDA</span>
							</div>
							...
							{:else}
								<div class="check-claim__action__status pending">
									...
									{#if walletResponse.totalSent > 0}
										<br />
										({Math.ceil(
											walletResponse.totalExcess - walletResponse.totalSent
										).toLocaleString()} / {Math.ceil(walletResponse.totalExcess).toLocaleString()})
									{/if}
								</div>
							{/if}
						</div>
						...
						<div class="check-claim__action">
							...
							<div class="check-claim__action__value">
								...
								<span
									>{(
										Math.ceil(walletResponse.totalCompensation * 100) / 100
									).toLocaleString()}</span
								>
							</div>
						...
						<div class="check-claim__info__wrap">
							<div class="check-claim__info">
								<div>
									...
									<br />
									<p>
										Send your excess DPANDA to the compensation wallet address below and within 24
										hours your compensation Algo amount will get deposited into your wallet.
									</p>
									<p>
										If you've sent more or less than the amount, we will refund it within 24 hours.
										If you've sent it from a different address than the one entered above, we will
										refund it within 24 hours.
									</p>
									<br />
